...
Full docs at WePay's Developer Documentation: https://www.wepay.com/developer
...
If your user already authorized your application 
    and you still have the access token, 
...
To set an [API-Version](https://www.wepay.com/developer/reference/versioning) 
    in the header with your call request, use::
